...
docker-compose --project-name crypto_payments_bot --file $docker_compose_file up bot &
docker-compose --project-name crypto_payments_bot --file $docker_compose_file up api
